...
{
    private final JButton[][] jBoard = new JButton[3][3];   
    ...
    private final String start = "283164705";
    //private final String start = "123485706";
    ...
    private void initComponents() 
    {
        ...
        this.setLayout(null);
        this.imagePieces("imagenes/minako.jpg");
        paintPieces();
    ...
    private void imagePieces(String pathName)
    {
        ...
        {      
            ...
            for(int i=0;i<3;i++)
                for(int j=0;j<3;j++)
                {
                    subImage = buffer.getSubimage((j)*166, (i)*166, 166, 166);  // Extrae un fragmento de la imagen 
